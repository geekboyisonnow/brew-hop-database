...
class BarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bar" do
    assert_difference('Bar.count') do
      post bars_url, params: { bar: { hours: @bar.hours, kind: @bar.kind, latitude: @bar.latitude, location: @bar.location, longitude: @bar.longitude, phone: @bar.phone } }
    end
  ...
  test "should update bar" do
    patch bar_url(@bar), params: { bar: { hours: @bar.hours, kind: @bar.kind, latitude: @bar.latitude, location: @bar.location, longitude: @bar.longitude, phone: @bar.phone } }
